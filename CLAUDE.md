...
`GAP-001` (`POA-PRS-001` vs. the repository's identifier convention) remains formally **HELD** — see `40-Runtime/PRS-001-CONFLICT-DOSSIER.md`. No repository identifier or directory may be renamed, moved, or restructured without a dedicated future governance mission resolving it, regardless of what other work is in progress.
