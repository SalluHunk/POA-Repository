...
|---|---|---|
| Temple Suite rejects generic ERP/CRM framing, centers devotee lifecycle | `SOURCE-DERIVED` | `Strategic Direction.pdf` pp.1,3; `temple-suite/page.tsx` "moat" section |
...
- **No prior artifact was rewritten.** `POA-PJR-002` receives one additive addendum (see companion diff) pointing to this document's existence; no existing section of any prior file is altered.
