...
|---|---|---|---|---|---|---|
| GAP-001 | `POA-PRS-001` artifact-identifier scheme conflicts with the repository's live convention | Category B — Structural Conflict | **HELD** (Commander decision) | Blocks adoption of a PRS-001-compliant identifier scheme. **Does NOT block Sprint Alpha (`POA-VIS-001`)** per `ADR-002`. | `POA-REPO-002` | Dedicated future governance mission to adopt / supersede / reconcile. Full evidence: `PRS-001-CONFLICT-DOSSIER.md`. |
